...
class Auth extends CI_Controller
{
    ...
    public function index()
    {
        ...
        //this will be change to user_role
    ...
    private function _login()
    {
        ...
        $login = $this->auth->authenticate($username);


       $isVerified = password_verify($password,$login[0]['password']);


       if($isVerified){


            $employee = $this->employee->get($login[0]['id']);

            $data = array(
                    //add whatsapp id soon
                  ...
                  'employee_type_id' => $employee[0]['employee_type_id'],
 ...
 public function logout()
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_user' => 'iancanto.silverre@gmail.com',
            'smtp_pass' => 'savira1103',
            'smtp_port' => 465,
            'mailtype' => 'html',
            'charset' => 'utf-8',
            'newline' => "\r\n",
        ...
        $this->email->initialize($config);  //tambahkan baris ini jika error ini : Message: mail(): Failed to connect to mailserver at "localhost" port 25, verify your "SMTP" and "smtp_port" setting in php.ini or use ini_set()

        $this->email->from('orangbaik1103@gmail.com', 'Web Programming Savira');
